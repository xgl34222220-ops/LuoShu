#!/system/bin/sh
# LuoShu v13.6 Beta6 - 设备与字体基础检测报告
set +e
...
{
    echo "LuoShu Font Report v13.6 Beta6"
    ...
    echo "GMS FontsProvider component:"
    cmd package get-component-enabled-setting --user 0 com.google.android.gms/com.google.android.gms.fonts.provider.FontsProvider 2>/dev/null || true
    echo "GMS font updater component:"
    cmd package get-component-enabled-setting --user 0 com.google.android.gms/com.google.android.gms.fonts.update.UpdateSchedulerService 2>/dev/null || true
    echo
    echo "Recent log:"
