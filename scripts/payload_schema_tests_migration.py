...
(ROOT / "scripts/module_update_state_test.sh").write_text(MODULE_UPDATE_TEST, encoding="utf-8")
(ROOT / "scripts/font_safety_test.sh").write_text(FONT_SAFETY_TEST, encoding="utf-8")
print("payload schema tests migrated")
