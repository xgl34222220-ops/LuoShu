...
grep -q '^version=v13.5 Stable Hotfix4$' "$ROOT/module.prop"
grep -q '^versionCode=13504$' "$ROOT/module.prop"
...
grep -q 'stability.js?v=13504' "$TMP_STAGE/webroot/index.html"
grep -q 'app.js?v=13504' "$TMP_STAGE/webroot/index.html"
grep -q 'style.css?v=13504' "$TMP_STAGE/webroot/index.html"
grep -q "STYLE_VERSION = '13504'" "$TMP_STAGE/webroot/stability.js"
