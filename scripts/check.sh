...
sh "$ROOT/scripts/provider_verify_after_restart_test.sh"
sh "$ROOT/scripts/engine_cache_invalidation_test.sh"
sh "$ROOT/scripts/runtime_ndk_selection_test.sh"
