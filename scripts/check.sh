...
python3 "$ROOT/scripts/font_role_error_test.py"
python3 "$ROOT/scripts/app_bridge_weight_axis_test.py"
python3 "$ROOT/scripts/legacy_composite_layout_test.py"
...
python3 "$ROOT/scripts/switch_provider_regression_test.py"
