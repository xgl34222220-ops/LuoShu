...
grep -q '^version=v13.6 Beta3$' "$ROOT/module.prop"
grep -q '^versionCode=13603$' "$ROOT/module.prop"
...
grep -q 'stability.js?v=13603' "$TMP_STAGE/webroot/index.html"
grep -q 'app.js?v=13603' "$TMP_STAGE/webroot/index.html"
grep -q 'style.css?v=13603' "$TMP_STAGE/webroot/index.html"
grep -q "STYLE_VERSION = '13603'" "$TMP_STAGE/webroot/stability.js"
