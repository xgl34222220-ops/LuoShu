...
grep -q '^version=v13.6 Beta4$' "$ROOT/module.prop"
grep -q '^versionCode=13604$' "$ROOT/module.prop"
...
grep -q 'stability.js?v=13604' "$TMP_STAGE/webroot/index.html"
grep -q 'app.js?v=13604' "$TMP_STAGE/webroot/index.html"
grep -q 'style.css?v=13604' "$TMP_STAGE/webroot/index.html"
grep -q "STYLE_VERSION = '13604'" "$TMP_STAGE/webroot/stability.js"
