...
grep -q '^version=v13.5 Stable Hotfix5$' "$ROOT/module.prop"
grep -q '^versionCode=13505$' "$ROOT/module.prop"
...
grep -q 'stability.js?v=13505' "$TMP_STAGE/webroot/index.html"
grep -q 'app.js?v=13505' "$TMP_STAGE/webroot/index.html"
grep -q 'style.css?v=13505' "$TMP_STAGE/webroot/index.html"
grep -q "STYLE_VERSION = '13505'" "$TMP_STAGE/webroot/stability.js"
...
grep -q 'LUOSHU_HYBRID_STAGE_BUDGET' "$TMP_STAGE/common/rom_adapters.sh"
! grep -q 'LUOSHU_HYBRID_COMPACT_ALIASES' "$TMP_STAGE/common/rom_adapters.sh"
! grep -q 'luoshu_link_compact_alias' "$TMP_STAGE/common/font_manager.sh"
