...
grep -q 'v14.js?v=14100' "$TMP_STAGE/webroot/index.html"; grep -q 'v14.css?v=14100' "$TMP_STAGE/webroot/index.html"
grep -q 'id="emojiSection"' "$TMP_STAGE/webroot/index.html"; grep -q '#emojiSection' "$TMP_STAGE/webroot/v14.css"
! grep -q 'v14_1.js?v=' "$TMP_STAGE/webroot/index.html"; ! grep -q 'v14_1.css?v=' "$TMP_STAGE/webroot/index.html"
