...
grep -q '^version=v13.6 Beta5$' "$ROOT/module.prop"
grep -q '^versionCode=13605$' "$ROOT/module.prop"
...
grep -q 'com.google.android.gms.*force-stop\|force-stop com.google.android.gms' "$ROOT/common/play_font_bridge"
...
grep -q 'stability.js?v=13605' "$TMP_STAGE/webroot/index.html"
grep -q 'app.js?v=13605' "$TMP_STAGE/webroot/index.html"
grep -q 'style.css?v=13605' "$TMP_STAGE/webroot/index.html"
grep -q "STYLE_VERSION = '13605'" "$TMP_STAGE/webroot/stability.js"
