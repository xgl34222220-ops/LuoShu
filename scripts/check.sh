...
grep -q '^version=v13.6 Beta1$' "$ROOT/module.prop"
grep -q '^versionCode=13601$' "$ROOT/module.prop"
grep -q '^auto$' "$ROOT/config/mount_mode.conf"
...
grep -q 'stability.js?v=13601' "$TMP_STAGE/webroot/index.html"
grep -q 'app.js?v=13601' "$TMP_STAGE/webroot/index.html"
grep -q 'style.css?v=13601' "$TMP_STAGE/webroot/index.html"
grep -q "STYLE_VERSION = '13601'" "$TMP_STAGE/webroot/stability.js"
