...
grep -q 'width:50px!important' "$ROOT/webroot/ui_refine.css"
...
grep -q 'grid-template-columns:1fr' "$ROOT/webroot/ui_refine.css"
...
grep -q 'environment.js?v=13503' "$TMP_STAGE/webroot/index.html"
...
grep -q "UI_VERSION = '13503'" "$TMP_STAGE/webroot/environment.js"
