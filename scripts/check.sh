...
grep -q '^version=v13.6 Beta2$' "$ROOT/module.prop"
grep -q '^versionCode=13602$' "$ROOT/module.prop"
...
grep -q 'stability.js?v=13602' "$TMP_STAGE/webroot/index.html"
grep -q 'app.js?v=13602' "$TMP_STAGE/webroot/index.html"
grep -q 'style.css?v=13602' "$TMP_STAGE/webroot/index.html"
grep -q "STYLE_VERSION = '13602'" "$TMP_STAGE/webroot/stability.js"
