...
rm -rf "$STAGE/webroot/fonts" "$STAGE/webroot/emoji" "$STAGE/logs" "$STAGE/backup" "$STAGE/config/recovery" "$STAGE/.font-transaction"
...
grep -q 'v14_1.js?v=14100' "$STAGE/webroot/index.html"; grep -q 'v14_1.css?v=14100' "$STAGE/webroot/index.html"
! grep -q 'id="emojiSection"' "$STAGE/webroot/index.html"; ! grep -q 'stability.js?v=' "$STAGE/webroot/index.html"
