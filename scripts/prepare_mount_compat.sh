...
sed -i \
    -e 's/v13\.5 Stable Hotfix[0-9][0-9]*/v13.6 Beta3/g' \
    -e 's/v13\.5 Stable/v13.6 Beta3/g' \
    -e 's/v13\.6 Beta[12]/v13.6 Beta3/g' "$STABILITY" "$SERVICE" 2>/dev/null || true
sed -i \
    -e 's/v13\.4 Beta2 Hotfix[0-9][0-9]*/v13.6 Beta3/g' \
    -e 's/v13\.5 Stable Hotfix[0-9][0-9]*/v13.6 Beta3/g' \
    -e 's/v13\.6 Beta[12]/v13.6 Beta3/g' \
