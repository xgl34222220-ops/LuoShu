...
function markVersion() {
    document.querySelectorAll('[data-module-version]').forEach(element => { element.textContent = 'v14.2 RC1'; });
    const engine = document.getElementById('engineVersion'); if (engine) engine.textContent = 'v14.2 RC1';
}
function initialize() {
