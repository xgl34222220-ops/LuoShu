...
function markVersion() {
    document.querySelectorAll('[data-module-version]').forEach(element => { element.textContent = 'v14.2 Alpha3'; });
    const engine = document.getElementById('engineVersion'); if (engine) engine.textContent = 'v14.2 Alpha3';
}
function initialize() {
