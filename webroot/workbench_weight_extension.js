...
function scheduleRender() {
    ...
    requestAnimationFrame(async () => {
        ...
        document.querySelectorAll('.workbench-version').forEach(element => { element.textContent = 'v14.2 RC1'; });
        ensureOverviewPanel();
...
function installStyles() {
    ...
    const link = document.createElement('link'); link.id = 'workbenchWeightStyles'; link.rel = 'stylesheet'; link.href = './workbench_weight_extension.css?v=14210'; document.head.appendChild(link);
}
function initialize() {
