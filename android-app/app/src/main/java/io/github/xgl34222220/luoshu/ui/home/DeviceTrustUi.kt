...
internal suspend fun loadDeviceTrustState(): DeviceTrustState {
    val command = """
        ...
        inventory=missing
        [ -s "${'"${'$'}(read_value "${'$'}CFG/device-font-engine.conf" state)"
...
}}CFG/device_font_inventory.json" ] && inventory=available
        slotSnapshot="${'"${'$'}(read_value "${'$'}CFG/device-font-engine.conf" state)"
        template="${'$'}(read_value "${'$'}CFG/device-font-template.state" state)"
        alignment="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" state)"
        mode="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" mode)"
        reason="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" reason)"
...
}}(read_value "${'"${'$'}(read_value "${'$'}CFG/device-font-engine.conf" state)"
        template="${'$'}(read_value "${'$'}CFG/device-font-template.state" state)"
        alignment="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" state)"
        mode="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" mode)"
        reason="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" reason)"
...
}}CFG/font-slot-snapshot.conf" state)"
        slotCount="${'"${'$'}(read_value "${'$'}CFG/device-font-engine.conf" state)"
        template="${'$'}(read_value "${'$'}CFG/device-font-template.state" state)"
        alignment="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" state)"
        mode="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" mode)"
        reason="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" reason)"
...
}}CFG/font-slot-snapshot.conf" slotCount)"
        targetCount="${'"${'$'}(read_value "${'$'}CFG/device-font-engine.conf" state)"
        template="${'$'}(read_value "${'$'}CFG/device-font-template.state" state)"
        alignment="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" state)"
        mode="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" mode)"
        reason="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" reason)"
...
}}CFG/font-slot-snapshot.conf" targetCount)"
        [ -n "${'"${'$'}(read_value "${'$'}CFG/device-font-engine.conf" state)"
        template="${'$'}(read_value "${'$'}CFG/device-font-template.state" state)"
        alignment="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" state)"
        mode="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" mode)"
        reason="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" reason)"
...
}}slotSnapshot" ] || slotSnapshot=missing
        case "${'"${'$'}(read_value "${'$'}CFG/device-font-engine.conf" state)"
        template="${'$'}(read_value "${'$'}CFG/device-font-template.state" state)"
        alignment="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" state)"
        mode="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" mode)"
        reason="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" reason)"
...
}}slotCount" in ''|*[!0-9]*) slotCount=0 ;; esac
        case "${'"${'$'}(read_value "${'$'}CFG/device-font-engine.conf" state)"
        template="${'$'}(read_value "${'$'}CFG/device-font-template.state" state)"
        alignment="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" state)"
        mode="${'$'}(read_value "${'$'}CFG/device-font-load-verification.conf" mode)"
...
}}targetCount" in ''|*[!0-9]*) targetCount=0 ;; esac
